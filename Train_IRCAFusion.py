...
models_path = ""
fusion_model = ""
Encoder_b_path_TNO =models_path
Encoder_m_path_TNO =models_path
Encoder_d_path_TNO =models_path
Decoder_path_TNO   =models_path

Encoder_b_path_FLIR =models_path
Encoder_m_path_FLIR =models_path
Encoder_d_path_FLIR =models_path
Decoder_path_FLIR   =models_path

Encoder_b_path_NIR =models_path
Encoder_m_path_NIR =models_path
Encoder_d_path_NIR=models_path
Decoder_path_NIR  =models_path
